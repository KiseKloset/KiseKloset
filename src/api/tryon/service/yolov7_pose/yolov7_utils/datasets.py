...
from yolov7_utils.general import (check_requirements, clean_str, resample_segments, segment2box,
                                  segments2boxes, xyn2xy, xywh2xyxy, xywhn2xyxy, xyxy2xywh,)
from yolov7_utils.torch_utils import torch_distributed_zero_first
...
def extract_boxes(
    path='../coco/',
):  # from yolov7_utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from yolov7_utils.datasets import *; autosplit('../coco')
    Arguments
